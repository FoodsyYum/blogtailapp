...
// Selectors for image field, imgage preview, and clear preview button
...
const handlePublishBlog = async function (event) {
    ...
    // Disabling the publish button to prevent multiple submissions.
    ...
    // Handle case where selected image size learger than 5MB.
...
document.addEventListener('keydown', (event) => {
    if (event.ctrlKey && event.key === 'Enter') { $publishBtn.click(); }
});