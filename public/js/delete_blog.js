 ...
 * @async
 * @param {stirng} blogId - The unique identifier of the blog to be deleted.
...
// Attaches click event listeners to all delete buttons to trigger to handleBlogDelete function.
